##############################################################################
# Ornith-1.0-35B IQ4_XS — llama-server GGUF
# Uso: make start  →  inicia o servidor
##############################################################################
...
help:
	@echo ""
	@echo "  Ornith-1.0-35B IQ4_XS — llama-server GGUF"
	@echo ""
	...
	@echo ""
	@echo "  API: http://localhost:8080/v1  |  Modelo: ornith"
	@echo ""
